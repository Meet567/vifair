        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">delhi_visit_table</h3>
                                      ...
                                      echo '<tr>
                                          ...
                                          <td>
                                              <div class="form-button-action">
                                                  <a href="../visitor/delhi_visit_data.php?delete_id=' . $row['id'] . '" class="btn btn-link btn-danger" onclick="return confirm(\'Are you sure you want to delete this record?\');">
